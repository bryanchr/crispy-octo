...
import com.example.lenovo.healthmax.Adapter.ListItemAdapter;
    ...
    private void updateData(String title, String description) {
        db.collection("TodoList").document(idUpdate)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(MedicationActivity.this, "Updated", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        db.collection("ToDoList")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MedicationActivity.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
